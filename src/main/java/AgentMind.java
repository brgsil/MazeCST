...
public class AgentMind extends Mind {
    ...
    private static double creatureBasicSpeed=0.5;
    private static float reachDistance=0.75f;
    ...
    public AgentMind(Environment env) {
		...
		innerSenseMO=createMemoryObject("INNER", cis);
                ...
                int[][] map = new int[(int)(env.world.getWorldHeigth()/env.WALL_SIZE)][(int)(env.world.getWorldWidth()/env.WALL_SIZE)];
		...
		Codelet leafletSense=new LeafletSense(env.creature);
		...
		pickUpJewel.addInput(leafletsMO);
...
//                ad.setProfiling(true);
    ...
    private Idea initializeInnerSenseIdea(){
        ...
        innerSense.add(new Idea("position", null, 1));
